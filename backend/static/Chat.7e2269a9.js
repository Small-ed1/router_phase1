function e(e,a,s,t){Object.defineProperty(e,a,{get:s,set:t,enumerable:!0,configurable:!0})}var a=globalThis.parcelRequire10c2,s=a.register;s("g3Ulu",function(s,t){Object.defineProperty(s.exports,"__esModule",{value:!0,configurable:!0}),e(s.exports,"default",()=>o);var r=a("ayMG0"),i=a("acw62"),n=a("kqWnA"),l=a("gC2yi"),o=({sessionId:e,onBack:a,onToggleResearch:s})=>{let[t,o]=(0,i.useState)([]),[c,d]=(0,i.useState)(""),[m,x]=(0,i.useState)(!1),[g,p]=(0,i.useState)(null),[h,u]=(0,i.useState)(!1),f=(0,i.useRef)(null),v=(0,i.useRef)(null);(0,i.useEffect)(()=>{b()},[e]),(0,i.useEffect)(()=>{j()},[t]);let b=async()=>{if(e)try{x(!0);let a=await fetch(`/api/chats/${e}`);if(a.ok){let e=await a.json();o(e.messages||[]),p(null)}else p("Failed to load chat session")}catch(e){p(`Error loading chat: ${e.message}`)}finally{x(!1)}},j=()=>{f.current?.scrollIntoView({behavior:"smooth"})},y=e=>new Date(e).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),w=async()=>{if(!c.trim()||m)return;let e={id:Date.now(),type:"user",content:c.trim(),timestamp:new Date};o(a=>[...a,e]),d(""),x(!0),p(null);try{setTimeout(()=>{let a={id:Date.now()+1,type:"ai",content:`This is a simulated response to: "${e.content}"
...
\`\`\``,timestamp:new Date};o(e=>[...e,a]),x(!1)},2e3)}catch(e){p(`Failed to send message: ${e.message}`),x(!1)}};return(0,r.jsxs)("div",{className:"chat-interface",children:[(0,r.jsxs)("div",{className:"chat-header",children:[(0,r.jsx)("button",{onClick:a,className:"back-button",children:"← Back to Sessions"}),(0,r.jsxs)("div",{className:"chat-info",children:[(0,r.jsx)("h3",{children:"Chat Session"}),(0,r.jsxs)("p",{children:["Session ID: ",e]})]}),(0,r.jsx)("div",{className:"chat-controls",children:(0,r.jsxs)("label",{className:"research-toggle",children:[(0,r.jsx)("input",{type:"checkbox",checked:h,onChange:e=>u(e.target.checked)}),(0,r.jsx)("span",{className:"toggle-label",children:"Deep Research Mode"})]})})]}),(0,r.jsxs)("div",{className:"chat-container",children:[(0,r.jsx)("div",{className:"messages-area",children:0!==t.length||m?(0,r.jsxs)(r.Fragment,{children:[t.map(e=>(0,r.jsx)("div",{children:"user"===e.type?(0,r.jsxs)("div",{className:"message user-message",children:[(0,r.jsx)("div",{className:"message-content",children:(0,r.jsx)("p",{children:e.content})}),(0,r.jsx)("div",{className:"message-meta",children:(0,r.jsx)("span",{className:"timestamp",children:y(e.timestamp)})})]}):(0,r.jsxs)("div",{className:"message ai-message",children:[(0,r.jsxs)("div",{className:"message-header",children:[(0,r.jsx)("div",{className:"ai-avatar",children:"🤖"}),(0,r.jsx)("div",{className:"ai-info",children:(0,r.jsx)("span",{className:"ai-name",children:"AI Assistant"})})]}),(0,r.jsx)("div",{className:"message-content",children:(0,r.jsx)("div",{className:"answer-text",children:(0,r.jsx)(n.default,{content:e.content})})}),(0,r.jsx)("div",{className:"message-meta",children:(0,r.jsx)("span",{className:"timestamp",children:y(e.timestamp)})})]})},e.id)),m&&(0,r.jsxs)("div",{className:"message ai-message",children:[(0,r.jsxs)("div",{className:"message-header",children:[(0,r.jsx)("div",{className:"ai-avatar",children:"🤖"}),(0,r.jsx)("div",{className:"ai-info",children:(0,r.jsx)("span",{className:"ai-name",children:"AI Assistant"})})]}),(0,r.jsx)("div",{className:"message-content",children:(0,r.jsxs)("div",{className:"loading-indicator",children:[(0,r.jsx)(l.default,{width:"100%",height:"1rem"}),(0,r.jsx)(l.default,{width:"80%",height:"1rem"}),(0,r.jsx)(l.default,{width:"60%",height:"1rem"})]})})]}),g&&(0,r.jsx)("div",{className:"error-message",children:(0,r.jsxs)("span",{children:["⚠️ ",g]})}),(0,r.jsx)("div",{ref:f})]}):(0,r.jsxs)("div",{className:"welcome-message",children:[(0,r.jsx)("div",{className:"welcome-icon",children:"💬"}),(0,r.jsx)("h4",{children:"Start a conversation"}),(0,r.jsx)("p",{children:"Type your message below to begin chatting with the AI assistant."})]})}),(0,r.jsx)("div",{className:"input-area",children:(0,r.jsxs)("div",{className:"message-input-container",children:[(0,r.jsx)("textarea",{ref:v,value:c,onChange:e=>d(e.target.value),onKeyPress:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),w())},placeholder:"Type your message... (Enter to send, Shift+Enter for new line)",disabled:m,rows:3}),(0,r.jsx)("button",{onClick:w,disabled:!c.trim()||m,className:"send-button",children:m?"⏳":"📤"})]})})]}),(0,r.jsx)("style",{children:`
        .chat-interface {
          height: 100%;
          display: flex;
...
//# sourceMappingURL=Chat.7e2269a9.js.map
